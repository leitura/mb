...
limite=$(echo $NUMERO | wc -m)
                  case $limite in
                       65) break;;
                        *) echo -e "\033[01;33m Por padrão, são\033[0m \033[01;36m64\033[0m \033[01;33mcaracteres, na\033[0m \033[01;45mVivo\033[0m, \033[01;33mum\033[0m \033[01;32maccessPass\033[0m, \033[01;32msctoken\033[0m, \033[01;32maPass\033[0m, \033[01;33mcole o conteúdo corretamente\033[0m"; sleep 5 ; clear
                  esac
           done
           clear && echo -e $tit
...
Menu
curl -s http://e.oi.ddivulga.com/api/gp -H "Origin: http://oi.ddivulga.com" -d "version=2" | cut -d '"' -f4
}
App6 () {
clear
               echo -e "\033[01;33mCole um \033[01;32msctoken \033[01;33mda\033[0m \033[01;33mOi\033[0m "
