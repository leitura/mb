...
os.system('clear')
print(f"{BANNER}")
print(f"     {DESTACAR}{GREEN}MB Free {VermelhoAll}@EhisOpeNer{NADA}    ")
print("        ")
...
if( option == '1' or option == '01'):
 ...
 if passi == "1":
   ...
   peo = input(f"{AZUL}Tecle {GREEN} Enter {NADA}no seu teclado xing ling")
   print()
...
os.system('clear')
print(f"{BANNER}\n{DESTACAR}{AMARELO}Mães solteiras a 39m...{NADA}")
time.sleep(3)
try:
